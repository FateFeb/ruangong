...
<div class="body-wrapper">
    ...
    <div class="page-wrapper mdc-toolbar-fixed-adjust">
      ...
      <div class="posi">
        <s:form action="storefindo" method="post" class="form1">
		<s:select name="columnName" class="input1" list="{'查询未接订单','查询已接未完成订单','查看已完成订单'}" headerKey="-1" headerValue="--请选择--" emptyOption="false" multiple="false"/>
