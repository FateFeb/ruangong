...
<!-- plugins:css -->
  ...
  <link rel="shortcut icon" href="images/favicon.png" />
    ...
    .posi .aa{margin:auto;width:66px;border: 1px solid #FFF;background-color: #899233;}
    .aa a{display: block;text-decoration:none;color:#656565;width:36px;line-height: 25px;text-align: center;margin:auto;padding:0 15px;color:#FFF;}
    .input1{width:200px;height:33psx;}
...
商家号：<s:property value="order.bid" /><br>
骑手号：<s:property value="order.rid" /><br>
货物信息：<s:property value="order.goods" /><br>
目的地址：<s:property value="order.end" /><br>
订单价格：<s:property value="order.price" /><br>
下单时间：<s:property value="order.starttime" /><br>
接单时间：<s:property value="order.gettime" /><br>
送达时间：<s:property value="order.endtime" /><br>
		  <div class="aa"><a href="orderfind.jsp">返回</a></div>
      </div>
      </main>
