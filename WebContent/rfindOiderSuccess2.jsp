...
<tr><td>开始时间:</td><td><s:textfield name="order.starttimr" value="%{starttime}"></s:textfield></td>
<s:submit value="完成"  />
</s:form>
</s:iterator>
</table>
