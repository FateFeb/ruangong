...
<body>
  <div class="body-wrapper">
    ...
    <div class="page-wrapper mdc-toolbar-fixed-adjust">
      ...
      <h3>个人信息</h3>
        <table>
        <s:form action="updaterider" class="action" method="post">
        <tr>
        <s:hidden name="rider.id" value="%{#session.rider_ylm1.id}" /></tr>
        <tr><td>姓名:</td><td><s:textfield class="padd" name="rider.name" value="%{#session.rider_ylm1.name}"></s:textfield></td></tr>
        <tr><td>密码:</td><td><s:textfield class="padd" name="rider.pwd" value="%{#session.rider_ylm1.pwd}"></s:textfield></td></tr>
        <tr><td>联系方式:</td><td><s:textfield class="padd" name="rider.phone" value="%{#session.rider_ylm1.phone}"></s:textfield></td></tr>
        <tr><s:hidden name="rider.state" value="%{#session.rider_ylm1.state}" /></tr>
        <tr><s:hidden name="rider.money" value="%{#session.rider_ylm1.money}" /></tr>
        <s:submit value="修改"  />
        </s:form>
        </table>
        </div>
