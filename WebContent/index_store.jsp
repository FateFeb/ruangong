      ...
      <nav class="mdc-persistent-drawer__drawer">
        ...
        <div class="mdc-list-group">
          <nav class="mdc-list mdc-drawer-menu">
            ...
            <div class="mdc-list-item mdc-drawer-item" href="storefindo.jsp" data-toggle="expansionPanel" target-panel="ui-sub-menu">
                ...
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
                  <div class="mdc-card py-3 pl-2 d-flex flex-row align-item-center">
                    ...
                    <div class="text-wrapper pl-1">
                      <h3 class="mdc-typography--display1 font-weight-bold mb-1">3</h3>
                      <p class="font-weight-normal mb-0 mt-0">本月已发订单数量</p>
                    </div>
                  </div>
                </div>
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
                  <div class="mdc-card py-3 pl-2 d-flex flex-row align-item-center">
                    ...
                    <div class="text-wrapper pl-1">
                      ...
                      <p class="font-weight-normal mb-0 mt-0">本日已发订单数量</p>
                    </div>
                  </div>
                </div>
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
                  <div class="mdc-card py-3 pl-2 d-flex flex-row align-item-center">
                    ...
                    <div class="text-wrapper pl-1">
                      <h3 class="mdc-typography--display1 font-weight-bold mb-1">￥35.0</h3>
                      <p class="font-weight-normal mb-0 mt-0">本月支付金额</p>
                    </div>
                  </div>
                </div>
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
                  <div class="mdc-card py-3 pl-2 d-flex flex-row align-item-center">
                    ...
                    <div class="text-wrapper pl-1">
                      <h3 class="mdc-typography--display1 font-weight-bold mb-1">￥10.0</h3>
                      <p class="font-weight-normal mb-0 mt-0">今日支付金额</p>
                    </div>
                  </div>
                </div>
              </div>
