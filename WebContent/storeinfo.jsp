...
<!-- plugins:css -->
  ...
  <link rel="shortcut icon" href="images/favicon.png" />
    ...
    .padd{margin-top:-23px;margin-left:10px;}
...
<div class="body-wrapper">
    ...
    <div class="page-wrapper mdc-toolbar-fixed-adjust">
      ...
      <h3>商家信息</h3>
		<table>
		<s:form action="updatestore" class="action" method="post">
		<tr>
		<s:hidden name="business.id" value="%{#session.business_ylm1.id}" /></tr>
		<tr><td>姓名:</td><td><s:textfield class="padd" name="business.name" value="%{#session.business_ylm1.name}"></s:textfield></td></tr>
		<tr><td>密码:</td><td><s:textfield class="padd" name="business.pwd" value="%{#session.business_ylm1.pwd}"></s:textfield></td></tr>
		<tr><td>联系方式:</td><td><s:textfield class="padd" name="business.phone" value="%{#session.business_ylm1.phone}"></s:textfield></td></tr>
		<tr><td>地址:</td><td><s:textfield class="padd" name="business.address" value="%{#session.business_ylm1.address}"></s:textfield></td></tr>
		<tr><s:hidden name="rider.state" value="%{#session.business_ylm1.state}" /></tr>
		<tr><s:hidden name="rider.money" value="%{#session.business_ylm1.money}" /></tr>
		<s:submit value="修改"  />
		</s:form>
		</table>
		</div>
