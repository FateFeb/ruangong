...
<div class="body-wrapper">
    ...
    <div class="page-wrapper mdc-toolbar-fixed-adjust">
      ...
      <div class="posi">
        <s:form action="tothree2" method="post" class="form1">
		<s:select name="columnName" class="input1" list="{'商家','骑手'}" headerKey="-1" headerValue="--请选择--" emptyOption="false" multiple="false"/>
		<s:textfield name="text" class="input2" placeholder="请输入内容"/>
