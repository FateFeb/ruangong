        ...
        <div class="demo2">
            <div class="container">
                <div class="row pad-15">
                    ...
                    <form action="tothree" method="post">
                    <div class="col-sm-3 wid">
                    
                         <s:submit  value="冻结" class="btn btn-lg orange padd"/>      
                    </div>
                    </form>
                    <form action="toone" method="post">
                    <div class="col-sm-3 wid">
                        <s:submit  value="解冻" class="btn btn-lg orange padd"/>
                    </div>
                    </form>
               </div>
           </div>
